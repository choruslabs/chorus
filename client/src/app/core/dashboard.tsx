...
export type Conversation = { id: string, name: string, description: string, author: { username: string } };
...
const DashboardPage = () => {
  ...
  return (
    <CoreBase>
      <div className='flex flex-col items-start h-full w-[90%] mx-auto py-10'>
        <div id="heading" className='flex w-full justify-between flex-wrap'>
          ...
          <a className='mb-8 px-5 py-3 bg-secondary text-white rounded-md h-fit' href='/conversation/new'>+ Create conversation</a>
        </div>
