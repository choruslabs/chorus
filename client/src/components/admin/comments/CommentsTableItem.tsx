      ...
      <td className="p-5">
        <div className="flex gap-4">
          ...
          {(comment.approved === null || !!comment.approved) && (
            <button className="border-2 px-2 py-2 rounded-xl flex flex-row items-center gap-x-2 h-min self-center-safe border-red-800 bg-red-100 hover:bg-red-800 hover:text-white">
              Reject
            </button>
          )}
        </div>
