      ...
      <div className='flex w-screen h-full'>
        <div className='flex flex-col w-full h-full'>
          <div className='flex flex-col w-full bg-gray-100 border-b'>
            <div className='flex items-center justify-between px-8 p-4 bg-white'>
          ...
          <div className='flex flex-col w-full h-full justify-center items-center'>
            ...
            {comment && (
              <div className='mx-8 p-5 w-3/4 rounded shadow-xl border'>
                <p className='font-semibold text-2xl text-center'>{comment?.content}</p>
